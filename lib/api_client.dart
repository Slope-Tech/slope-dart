...
class ApiClient {
  ApiClient({this.basePath = 'https://api.slope.so/prod/v2'}) {
    // Setup authentications (key: authentication name, value: authentication).
    _authentications[r'privateToken'] = HttpBearerAuth();
    _authentications[r'publicToken'] = HttpBearerAuth();
  }
  ...
  static dynamic _deserialize(dynamic value, String targetType, {bool growable}) {
    try {
      switch (targetType) {
        ...
        case 'CreateCustomerParams':
          return CreateCustomerParams.fromJson(value);
        case 'CreateLoanParams':
          return CreateLoanParams.fromJson(value);
        case 'Error':
        ...
        case 'InlineResponse201LoanSchedule':
          return InlineResponse201LoanSchedule.fromJson(value);
        case 'InlineResponse201TotalAmount':
          return InlineResponse201TotalAmount.fromJson(value);
        case 'LoanApplication':
          return LoanApplication.fromJson(value);
        case 'LoanApplicationBuyer':
          return LoanApplicationBuyer.fromJson(value);
        case 'LoanApplicationBuyerAddress':
          return LoanApplicationBuyerAddress.fromJson(value);
        case 'LoanApplicationBuyerStripeInfo':
          return LoanApplicationBuyerStripeInfo.fromJson(value);
        case 'LoanApplicationItems':
          return LoanApplicationItems.fromJson(value);
        case 'LoanApplicationLoanPrice':
          return LoanApplicationLoanPrice.fromJson(value);
        case 'Merchant':
          return Merchant.fromJson(value);
        case 'MerchantApiKey':
          return MerchantApiKey.fromJson(value);
        case 'MerchantStripe':
          return MerchantStripe.fromJson(value);
        case 'MerchantSubscriptionSchedules':
          return MerchantSubscriptionSchedules.fromJson(value);
        default:
          Match match;
